<?php
App::uses('PatientPastHistoriesController', 'Controller');

/**
 * PatientPastHistoriesController Test Case
 */
class PatientPastHistoriesControllerTest extends ControllerTestCase {
