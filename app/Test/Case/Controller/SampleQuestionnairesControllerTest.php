<?php
App::uses('SampleQuestionnairesController', 'Controller');

/**
 * SampleQuestionnairesController Test Case
 */
class SampleQuestionnairesControllerTest extends ControllerTestCase {
