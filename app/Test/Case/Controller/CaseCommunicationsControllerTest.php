<?php
App::uses('CaseCommunicationsController', 'Controller');

/**
 * CaseCommunicationsController Test Case
 */
class CaseCommunicationsControllerTest extends ControllerTestCase {
