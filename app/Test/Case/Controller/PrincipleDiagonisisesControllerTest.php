<?php
App::uses('PrincipleDiagonisisesController', 'Controller');

/**
 * PrincipleDiagonisisesController Test Case
 */
class PrincipleDiagonisisesControllerTest extends ControllerTestCase {
