<?php
App::uses('DoctorSpecializetionsController', 'Controller');

/**
 * DoctorSpecializetionsController Test Case
 */
class DoctorSpecializetionsControllerTest extends ControllerTestCase {
