...
<div style="width:100%;border-bottom: 2px solid #fff; margin-bottom:15px;">
	...
	<h1 style="font-family:Tahoma, Geneva, sans-serif; font-size:16px;color: #fff; font-weight:600; padding:0 0 10px 0; margin:0;">Message</h1>
	
	<div style="width:100%; padding:0 0 10px 0;" mc:edit="details">
		<p style="margin:0 0 5px 10px;"><?=$message?></p>
	</div>
