...
<div style="width:100%;border-bottom: 2px solid #fff; margin-bottom:15px;">
	...
	<div style="width:100%; padding:0 0 10px 0;" mc:edit="details">
		...
		<p style="margin:0 0 5px 10px;">Case Close Date : <?=$case_close_date?></p>
		<p style="margin:0 0 5px 10px;">Case Delete Date : <?=$case_delete_date?></p>
		<p style="margin:0 0 5px 10px;">Your Comment : <?=$opinion_comment?></p>
	</div>
