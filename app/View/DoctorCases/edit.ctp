...
<?php echo $this->Form->create('DoctorCase'); ?>
	<fieldset>
		<legend><?php echo __('Edit Doctor Case'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('DoctorCase.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('DoctorCase.id')))); ?></li>
