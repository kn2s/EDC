...
<?php echo $this->Form->create('SampleOpinion'); ?>
	<fieldset>
		<legend><?php echo __('Admin Edit Sample Opinion'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('SampleOpinion.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('SampleOpinion.id')))); ?></li>
