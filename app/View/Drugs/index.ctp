<div class="drugs index">
	...
	<tr>
		...
		<td><?php echo h($drug['Drug']['drugname']); ?>&nbsp;</td>
		<td><?php echo h($drug['Drug']['quantity']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $drug['Drug']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $drug['Drug']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
