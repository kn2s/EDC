...
<div class="Wrapper">
  <div class="questionnaireHeading">
  	<div class="container">
	<?php echo $this->Html->link($this->Html->image('cross2.png',array('alt'=>'X')),array('controller'=>'doctors','action'=>'dashboard','full_base'=>false),array('escape'=>false,'class'=>'crossButton')); ?>
        <div class="clear"></div>
        <div class="TextPart">
        	<h2>Opinion</h2>
            <!--<p>Thank you for using our services! At this point, these are our comments and<br> recommendations.</p>-->
        </div>
		<?php echo $this->Html->link($this->Html->image('questionnairLogo.png',array('alt'=>'')),array('controller'=>'doctors','action'=>'dashboard','full_base'=>true),array('escape'=>false,'class'=>'logo')); ?>
        <div class="clear"></div>
    </div>
  </div>
