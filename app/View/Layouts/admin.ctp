            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
						...
						<li>
                           <a href="javascript:void(0)"><i class="fa fa-table fa-fw"></i>Refference<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
									<?php echo $this->Html->link('Samples',array('controller'=>'References','action'=>'index','full_base'=>true),array('escape'=>false));?>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
